...
- Busca de Elementos O(n): A função encontrar_elemento tem uma complexidade proporcional ao número de iframes presentes na página. No pior caso, ela percorre todos os frames e aguarda o timeout de cada um O(n).
